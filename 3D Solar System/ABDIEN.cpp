...
void updateCameraDirection()
{
    ...
    float yawRadians = cameraYaw * 3.14159265358979323846f / 180.0f;
    float pitchRadians = cameraPitch * 3.14159265358979323846f / 180.0f;
    float direction[3] = {
...
void keyboard_callback(unsigned char key, int x, int y)
{
    ...
    switch (key)
    {
        ...
        {
            float right[3] = {
                sinf(yawRadians + 3.14159265358979323846f / 2.0f),
                0.0,
                cosf(yawRadians + 3.14159265358979323846f / 2.0f)
            };
            for (int i = 0; i < 3; i++)
